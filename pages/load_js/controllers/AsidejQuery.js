...
export default function AsidejQuery() {
    ...
    if (effectRun.current === true) {
      ...
      const asideExpand = () => {
        if (localStorage.getItem("aside-expand") == "true") {
          ...
          $(".aside-extra-menu-lg ,.aside-extra-menu-expand").toggleClass(
            "d-none d-block"
          );
      ...
      $(document).ready(() => {
        ...
        $(".menu-bars").on("click", function (event) {
          $(".erp-aside-menue-toggle").toggleClass(
            "aside-fixd-none aside-fixd-block"
          );
          $(".erp-aside").toggleClass("aside d-xxsm-block d-smd-none").animate(
            {
              left: "0%",
            },
            500,
      ...
      $(document).ready((_) => {
        ...
        $("#both-gradient").on("click toutch", function (e) {
          if ($(this).prop("checked")) {
            ...
            $(".erp-header-right").removeClass(
              "theme-lightblue theme-darkblue"
            );
            $(".erp-container").removeClass(
              "erp-bg-front-blue erp-bg-front-darkblue erp-bg-front-darkorange  erp-bg-front-darkgreen "
            );
            ...
            $("aside").removeClass(
              "theme-darkblue theme-lightblue  aside-gradient"
            );
            $("#default-aside").prop("checked", true);
            // default nav theme
            $(".erp-header-right").removeClass(
              "theme-lightblue theme-darkblue nav-gradient"
            );
            localStorage.setItem("nav-theme", "default");
            $("#default-nav").prop("checked", true);
            // default main
            $(".erp-container").removeClass(
              "erp-bg-front-blue erp-bg-front-darkblue erp-bg-front-darkorange  erp-bg-front-darkgreen bg-gradient"
            );
        ...
        $("#body-dark-green").on("change toutch", function () {
          $("#both-gradient").prop("checked", false);
          $(".erp-container").removeClass(
            "erp-bg-front-blue erp-bg-front-dark-blue erp-bg-front-darkorange  erp-bg-front-darkgreen"
          );
      ...
      $(document).ready((_) => {
        ...
        $(".nav-link").on("click toutch", function (event) {
          event.preventDefault();
          event.stopPropagation();
          $(".dropdown-message").slideUp(200);
          var target = $(this).attr("data-target");
          $(target).slideDown(200);
        });

        $(".dropdown-message").on("click toutch", function (event) {
      ...
      return () => (effectRun.current = false);
    }
  }, []);
  return <></>;
}
