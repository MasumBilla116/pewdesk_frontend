...
function InventoryInOut(props: any) {
  ...
  return (
    <>
      <Head>
        ...
        <title>IVM | Inventory in out</title>
      </Head>
              ...
              <div className="all-content-wraper">
                ...
                <div className="container-fluid pt-3 pb-3 dashboard-content">
                  ...
                  <div className="table-responsive mt-3">
                    ...
                    >
                      <caption>Inventory In-Out Ledger</caption>
...
export default memo(InventoryInOut);
