...
export default function Reveinue(props: any) {
  ...
  const UpdateInfo = async (target: any) => {
    ...
    UpdateItem(
      "/update/hcm/budget/revienue/info",
      formData,
      setLoader,
      FetchPaginateInfo,
      paginateUrl
              ...
              <div className="all-content-wraper">
                ...
                <div className="container-fluid pt-3 pb-3 dashboard-content">
                  ...
                  <div className="table-responsive">
                    ...
                    >
                      <caption>Budget Revenue Ledger</caption>
        ...
        <div className=" modal-dialog modal-fullscreen-sm modal-fullscreen-md">
          <div className="modal-content modal-content-bg">
            <div className="modal-header">
              <h1 className="text-caption">Add Budget Revienue</h1>
              <button
            ...
            <div className="modal-body">
              <form
                onSubmit={handleSubmit((data) =>
                  StoreItem(
                    "/store/hcm/budget/revienue/info",
                    data,
                    setLoader,
                    FetchPaginateInfo,
                    paginateUrl
      ...
      {budgetExpensesPaginateInfo?.data?.map((data: any) => (
        ...
        >
          <div className=" modal-dialog modal-fullscreen-sm modal-fullscreen-md">
            <div className="modal-content modal-content-bg">
              <div className="modal-header">
                <h1 className="text-caption">Edit Budget Revienue</h1>
                <button
                  className="btn-close bg-light"
                  data-bs-dismiss="modal"
                ></button>
...
export async function getServerSideProps(context: any) {
  ...
  const budgetExpensesData = await FetchData(
    `/get/hcm/budget/revienue/info/${id}`
  );
