              ...
              <div className="all-content-wraper">
                ...
                <div className="container-fluid pt-3 pb-3 dashboard-content">
                  ...
                  <div className="table-responsive mt-3">
                    ...
                    >
                      <caption>Invoice Ledger</caption>
        ...
        <div className=" modal-dialog modal-fullscreen-sm modal-fullscreen-md">
          <div className="modal-content modal-content-bg">
            <div className="modal-header">
              <h1 className="text-caption">Add Invoice</h1>
              <button
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-4">
                      <div className="form-input-con">
                        ...
                        />
                        <label htmlFor="add-client" className="form-label">
                          Client
                        </label>
                      </div>
                      <div className="text-warning">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-4 mt-5">
                      <div className="form-date">
                        <label htmlFor="add-create-date" className="form-label">
                          Create Date
                        </label>
                      ...
                      <div className="text-warning">
                        {errors.create_date?.type === "required" &&
