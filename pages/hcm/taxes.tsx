                    ...
                    >
                      ...
                      <thead className="text-center">
                        ...
                        <tr>
                          ...
                          <th scope="col">Tax Percentage &lpar;%&rpar;</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="debit text-danger text-end">Jon</td>
                          <td className="credit text-light text-end">14%</td>
                          <td className="credit text-success text-center">
                            <span className="badge rounded bg-warning">
                              Inactive
                            </span>{" "}
                          </td>
