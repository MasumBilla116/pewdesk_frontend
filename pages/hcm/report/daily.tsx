                                        ...
                                        <table id="printable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="debit text-danger text-end"> IOS Devloper </td>
                                                    <td className="credit text-success text-center">
                                                        <button type="button" className="btn btn-outline-warning">Week Off</button>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="debit text-danger text-end"> IOS Devloper </td>
                                                    <td className="credit text-success text-center">
                                                        <button type="button" className="btn btn-outline-danger">Absent</button>
                                                    </td>
